          ...
          fields: [
            ...
            },
            {
              ...
              options: [
                ...
                { label: 'Show Pitch', value: 'show_pitch' },
                { label: 'Playlist Placement', value: 'playlist_placement' },
                { label: 'Event Performance', value: 'event_performance' },
                { label: 'Sponsor Collaboration', value: 'sponsor_collab' },
                { label: 'General Creator Upload', value: 'general_upload' },
              ],
            },
            {
              name: 'description',
          ...
          fields: [
            ...
            },
            {
              ...
              options: [
                ...
                { label: 'Mature Themes', value: 'mature_themes' },
              ],
            },
            {
