          ...
          fields: [
            ...
            },
            {
              ...
              options: [
                ...
                { label: 'Artist Announcement', value: 'artist_announcement' },
                { label: 'Playlist Drop', value: 'playlist_drop' },
                { label: 'Chart Moment', value: 'chart_moment' },
                { label: 'Creator Hub Release', value: 'creator_hub_release' },
              ],
            },
            {
              type: 'row',
          ...
          fields: [
            ...
            },
            {
              ...
              options: [
                ...
                { label: 'Indie Spotlight', value: 'indie_spotlight' },
                { label: 'Staff Pick', value: 'staff_pick' },
                { label: 'Southern Soul Pick', value: 'southern_soul_pick' },
                { label: 'Gospel Pick', value: 'gospel_pick' },
                { label: 'R&B/Soul Pick', value: 'rb_soul_pick' },
                { label: 'Hip-Hop Pick', value: 'hip_hop_pick' },
                { label: 'Video Premiere', value: 'video_premiere' },
                { label: 'Chart Breakout', value: 'chart_breakout' },
              ],
            },
            {
              name: 'reviewStatus',
          ...
          fields: [
            ...
            },
            {
              ...
              options: [
                ...
                { label: 'Radio Show Page', value: 'radio_show_page' },
              ],
            },
            {
              name: 'displayOrder',
