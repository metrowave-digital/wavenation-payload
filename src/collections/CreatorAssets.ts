      ...
      tabs: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              defaultValue: 'other',
              options: [
                { label: 'Master Audio', value: 'master-audio' },
                ...
                { label: 'Caption File', value: 'caption-file' },
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              name: 'licenseType',
              type: 'select',
              defaultValue: 'creator-owned',
              options: [
                { label: 'Creator Owned', value: 'creator-owned' },
                { label: 'WaveNation Licensed', value: 'wavenation-licensed' },
                ...
                { label: 'Unknown / Needs Review', value: 'needs-review' },
              ],
            },
            {
              ...
              fields: [
                {
                  ...
                  options: [
                    ...
                    { label: 'Sponsor Use', value: 'sponsor-use' },
