...
export const AdPlacements: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      required: true,
      options: [
        { label: 'Display Banner', value: 'display_banner' },
        { label: 'Native Card', value: 'native_card' },
        { label: 'Article Sidebar', value: 'article_sidebar' },
        { label: 'Homepage Hero', value: 'homepage_hero' },
        { label: 'Audio Pre-Roll', value: 'audio_preroll' },
        { label: 'Audio Mid-Roll', value: 'audio_midroll' },
        { label: 'Video Pre-Roll', value: 'video_preroll' },
        { label: 'Video Mid-Roll', value: 'video_midroll' },
        { label: 'TV Lower Third', value: 'tv_lower_third' },
        { label: 'Player Banner', value: 'player_banner' },
        { label: 'Newsletter Slot', value: 'newsletter_slot' },
        { label: 'Sponsored Playlist Slot', value: 'sponsored_playlist_slot' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'HTML / Native', value: 'html_native' },
        { label: 'Audio 15s', value: 'audio_15' },
        { label: 'Audio 30s', value: 'audio_30' },
        { label: 'Video 6s', value: 'video_6' },
        { label: 'Video 15s', value: 'video_15' },
        { label: 'Video 30s', value: 'video_30' },
        { label: 'Text Sponsorship', value: 'text_sponsorship' },
      ],
    },
    {
      name: 'pricing',
