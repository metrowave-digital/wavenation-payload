...
export const ReleaseForms: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      required: true,
      options: [
        { label: 'Talent Release', value: 'talent-release' },
        { label: 'Creator Agreement', value: 'creator-agreement' },
        { label: 'Photo Release', value: 'photo-release' },
        { label: 'Video Release', value: 'video-release' },
        { label: 'Audio / Podcast Release', value: 'audio-podcast-release' },
        { label: 'Music Release', value: 'music-release' },
        { label: 'Venue Release', value: 'venue-release' },
        { label: 'Event Release', value: 'event-release' },
        { label: 'Minor Release', value: 'minor-release' },
        { label: 'Sponsor / Brand Release', value: 'sponsor-brand-release' },
        { label: 'General Liability Release', value: 'general-liability-release' },
      ],
    },
    {
      name: 'relatedContent',
      ...
      fields: [
        {
          ...
          options: [
            { label: 'Third-Party Provider', value: 'third-party' },
            { label: 'DocuSign', value: 'docusign' },
            { label: 'Dropbox Sign', value: 'dropbox-sign' },
        ...
        },
        {
          ...
          options: [
            ...
            { label: 'Manual Complete', value: 'manual-complete' },
          ],
        },
        {
          name: 'sentAt',
