  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Live Show Chat', value: 'live-show' },
        { label: 'Live TV / Stream Chat', value: 'live-stream' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Creator Members Only', value: 'creator-members' },
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Live Stream', value: 'live-streams' },
