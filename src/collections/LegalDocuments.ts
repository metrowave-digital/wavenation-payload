  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'DMCA Policy', value: 'dmca_policy' },
        { label: 'Accessibility Statement', value: 'accessibility_statement' },
        { label: 'Creator Terms', value: 'creator_terms' },
        { label: 'Subscriber Terms', value: 'subscriber_terms' },
        { label: 'Advertising Terms', value: 'advertising_terms' },
        { label: 'Sponsorship Terms', value: 'sponsorship_terms' },
        { label: 'Release Form Template', value: 'release_form_template' },
        { label: 'Contest Rules', value: 'contest_rules' },
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Creators Only', value: 'creators_only' },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          hasMany: true,
          options: [
            { label: 'Account Signup', value: 'account_signout' },
            { label: 'WaveNation+ Subscription', value: 'plus_subscription' },
            { label: 'Creator Hub Access', value: 'creator_hub_access' },
            { label: 'Music Submission', value: 'music_submission' },
            { label: 'Event Registration', value: 'event_registration' },
            { label: 'Sponsor / Advertiser Portal', value: 'sponsor_advertiser_portal' },
          ],
        },
      ],
    },
