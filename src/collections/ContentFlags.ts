  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Explicit Sexual Content', value: 'explicit_sexual_content' },
        { label: 'Graphic Content', value: 'graphic_content' },
        { label: 'Misinformation', value: 'misinformation' },
        { label: 'Spam / Scam', value: 'spam_scam' },
        { label: 'Privacy / Doxxing', value: 'privacy_doxxing' },
        { label: 'Defamation / Legal Risk', value: 'defamation_legalRisk' },
      ...
      fields: [
        {
          ...
          options: [
            ...
            { label: 'Automated System', value: 'automated_system' },
