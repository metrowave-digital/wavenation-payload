      ...
      tabs: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'select',
              required: true,
              defaultValue: 'creator-terms',
              options: [
                { label: 'Creator Terms', value: 'creator-terms' },
                { label: 'Revenue Share', value: 'revenue-share' },
                { label: 'Content License', value: 'content-license' },
                { label: 'Event Performance Agreement', value: 'event-performance' },
                { label: 'Sponsorship Collaboration', value: 'sponsorship-collab' },
                { label: 'NDA', value: 'nda' },
                { label: 'Release Form', value: 'release-form' },
                { label: 'Third-Party Signing Packet', value: 'third-party-signing' },
              ],
            },
            {
          ...
          fields: [
            {
              ...
              options: [
                ...
                { label: 'Jotform Sign', value: 'jotform-sign' },
