  ...
  fields: [
    ...
    },
    {
      ...
      options: [
        ...
        { label: 'Partially Cleared', value: 'partially_cleared' },
        { label: 'Needs License', value: 'needs_license' },
        { label: 'Expired', value: 'expired' },
        { label: 'Rejected', value: 'rejected' },
        { label: 'Takedown Required', value: 'takedown_required' },
      ],
    },
    {
      name: 'licenseType',
      ...
      options: [
        ...
        { label: 'Creator-Owned / Platform License', value: 'creator_owned_platform_license' },
        { label: 'Work Made for Hire', value: 'work_made_for_hire' },
        { label: 'Fair Use Review', value: 'fair_use_review' },
        { label: 'Public Domain', value: 'public_domain' },
        { label: 'Creative Commons', value: 'creative_commons' },
        { label: 'Third-Party Permission', value: 'third_party_permission' },
      ],
    },
    {
      name: 'rightsHolder',
